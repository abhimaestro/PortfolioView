...
class PasscodeStagingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //VENTouchLock.sharedInstance().setKeychainService("PortfolioView", keychainAccount: UserDefaultValues.loggedInUserName, touchIDReason: "Scan your fingerprint to unlock", passcodeAttemptLimit: 3, splashViewControllerClass: LockSplashViewController.self)
